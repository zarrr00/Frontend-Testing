        ...
        <AnimatedContent distance={30} delay={0.1} direction="vertical">
          <header>
            ...
            <p className="text-sm text-muted-foreground mt-1 text-balance">
              {"Pantau riwayat lengkap sirkulasi keuangan KasFlow dalam satu layar lebar." || "Pantau riwayat lengkap sirkulasi keuangan KasFlow dalam satu layar lebar."}
            </p>
          </header>
        </AnimatedContent>
        ...
        {filteredTransactions.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-muted-foreground border-2 border-dashed border-border rounded-xl bg-card/50">
            ...
            <p className="text-sm mt-1 opacity-80">
              {"Tidak ada riwayat yang cocok dengan kata kunci Anda." || "Tidak ada riwayat yang cocok dengan kata kunci Anda."}
            </p>
          </div>
        )}
      </AnimatedContent>
