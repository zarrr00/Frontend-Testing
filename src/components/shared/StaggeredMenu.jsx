...
export const StaggeredMenu = ({
  ...
  className,
  logoUrl = '/src/assets/KasFlow.png',
  menuButtonColor = '#fff',
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            <div className="flex items-center gap-3">
              <div className="bg-gradient-to-br from-purple-600 to-purple-400 p-2 rounded-xl shadow-[0_0_15px_rgba(168,85,247,0.4)]">
                <Wallet size={24} className="text-white" />
              </div>
              <span className="text-[1.75rem] font-bold tracking-tight text-white">KasFlow</span>
            </div>
          </div>
  ...
  ref={panelRef}
  className="staggered-menu-panel absolute top-0 right-0 h-full bg-[#0D0716]/80 flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto border-l border-purple-500/20"
                  ...
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      ...
                      onClick={(e) => {
                        ...
                        }, 400); // Tunggu animasi panel selesai (0.32s + margin)
                      }}
...
.sm-scope .sm-logo-img { display: block; height: auto; max-height: 48px; width: auto; object-fit: contain; }
